...
const LBR:FC<Props> = ({languageBasedRepo}) => {
  ...
  return (
    <div className='max-w-6x mx-auto font-secondary mb-20 px-5 tablet:px-10 '>
      <div className='flex justify-center max-w-sm mx-auto tablet:max-w-2xl flex-wrap gap-x-3 gap-y-4 tablet:gap-x-5'>
        {
          filtered.map( ({ count, lang }) => (
            <div key={lang} className='max-w-[100px] items-center flex justify-center flex-col'>
      ...
      <div className='text-center font-thin text-[3rem] leading-10 tablet:leading-[3.8rem] max-w-[20rem] tablet:max-w-[40rem] mx-auto tablet:text-[3.1rem] mt-[22px]'>
        <p>
