    ...
    <div className='flex px-6'>        
        <Link href={"/"}>
          <div className='flex gap-x-2 items-center cursor-pointer group'>
              <div className='flex justify-center w-[50px] border-white transition bg-opacity-10  duration-500 ease-in border-[1px] hover:border-[2px] hover:border-primaryTwo rounded-full h-[50px] tablet:w-[50px] tablet:h-[50px]'>
