...
const Footer:FC<FooterProps> = ({footer})=> {
  return (
    <div className='mx-auto bg-skyMOGH rounded-[10px] '>
      <div className='px-[10px] py-[20px] tablet:py-[50px] flex justify-center  bg-grayDarkMOGH rounded-[10px]'>
      ...
      <div className='flex px-[100px] py-[40px] justify-between bg-skyMOGH'>
        <div>
          <h6 className='tablet:text-[22px] laptop:text-[25px] text-grayDarkMOGH font-medium'>Any Question?</h6>
          <p className='tablet:text-[14px] laptop:text-[16px] text-grayDimMOGH '>mog@gmail.com</p>
        </div>
