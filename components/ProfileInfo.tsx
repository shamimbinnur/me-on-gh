    ...
    <div className='p-10'>
        ...
        <div className="p-8 bg-bgWhite rounded-xl">
          <div className="flex flex-col flex-wrap tablet:flex-row gap-6">
            {/* Left portion */}
            <div className="bg-white tablet:min-w-[400px] rounded-xl border-[1px] flex-1 p-5 border-gray-100">
            ...
            {/* Right portion */}
            <div className="bg-white tablet:min-w-[400px] rounded-xl gap-x-4 flex p-5 border-[1px] items-center justify-center flex-1 border-gray-100">
              ...
              <div className="border-l-2 flex-1 border-l-gray-200 py-4 px-4 ">
                <div>
                  <p className="text-gray-500">Total public repo</p>
